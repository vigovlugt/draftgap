            ...
            <For each={props.options}>
                {(option, i) => (
                    <button
                        type="button"
                        class={cn(
                            "uppercase leading-4 relative inline-flex items-center border text-neutral-300 border-neutral-700 bg-primary px-3 font-medium hover:bg-neutral-600 focus:z-10 py-3 transition ease-in-out duration-150",
                            {
                                "rounded-r-md":
