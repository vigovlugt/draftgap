    ...
    return (
        ...
        >
            ...
            <p class="font-body mb-4">
                ...
                mind. First of all, the data is based on the last 30 days, so it
                is not a perfect representation of the current meta. Secondly,
                the overall team comp identity is not taken into account. The
                synergy of duos within a team are used in the calculations, but
                the tool does not know about team comp identity like 'engage' or
                'poke'. We also do not look at the damage composition (but it is
                shown, above the team winrate), so you need to keep this in mind
                on you own.
                <br />
